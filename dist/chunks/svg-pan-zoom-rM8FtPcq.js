import { c as P, g as V } from "./mermaid-Cn29Rjho.js";
function L(t, e) {
...
var q = function() {
  var t = "", e, o, i, s = [], n = { passive: !0 }, a = { passive: !1 };
  ...
  function O(h, l, f) {
    S(h, i, l, f), i == "DOMMouseScroll" && S(h, "MozMousePixelScroll", l, f);
  }
  return {
    on: T,
    off: O
  ...
  mouseAndTouchNormalize: function(t, e) {
    if (t.clientX === void 0 || t.clientX === null)
      ...
      } else t.originalEvent !== void 0 && t.originalEvent.clientX !== void 0 && (t.clientX = t.originalEvent.clientX, t.clientY = t.originalEvent.clientY);
  },
  /**
...
var C = {
  ...
  setCTM: function(t, e, o) {
    ...
    t.setAttributeNS(null, "transform", s), "transform" in t.style ? t.style.transform = s : "-ms-transform" in t.style ? t.style["-ms-transform"] = s : "-webkit-transform" in t.style && (t.style["-webkit-transform"] = s), N === "ie" && o && (o.parentNode.insertBefore(o, o), window.setTimeout(function() {
      i.refreshDefsGlobal();
...
u.prototype.updateCTM = function() {
  var t = this.getCTM();
  W.setCTM(this.viewport, t, this.defs), this.pendingUpdate = !1, this.options.onUpdatedCTM && this.options.onUpdatedCTM(t);
};
var R = function(t, e) {
  return new u(t, e);
}, B = q, E = k, v = z, b = C, U = R, r = function(t, e) {
  this.init(t, e);
}, G = {
...
r.prototype.init = function(t, e) {
  var o = this;
  this.svg = t, this.defs = t.querySelector("defs"), b.setupSvgAttributes(this.svg), this.options = v.extend(v.extend({}, G), e), this.state = "none";
  var i = b.getBoundingClientRectNormalized(
    t
  );
  this.width = i.width, this.height = i.height, this.viewport = U(
...
r.prototype.setupHandlers = function() {
  ...
  for (var s in this.eventListeners)
    (this.options.eventsListenerElement || this.svg).addEventListener(
      ...
      this.options.preventMouseEventsDefault ? !1 : D
    );
...
const j = /* @__PURE__ */ V(I), F = /* @__PURE__ */ L({
  __proto__: null,
  default: j
}, [I]);
export {
...
//# sourceMappingURL=svg-pan-zoom-rM8FtPcq.js.map
